...
\contentsline {section}{\numberline {2.2}Rodzaje klawiatur muzycznych}{10}{section.2.2}
\contentsline {section}{\numberline {2.3}Przegląd metod syntezy dźwięku }{12}{section.2.3}
\contentsline {section}{\numberline {2.4}Klasyczne moduły syntezatorów dźwięku }{12}{section.2.4}
\contentsline {section}{\numberline {2.5}Analogowa i cyfrowa synteza dźwięku }{12}{section.2.5}
\contentsline {section}{\numberline {2.6}Protokół MIDI }{12}{section.2.6}
\contentsline {section}{\numberline {2.7}Dyskretna transformata Fouriera}{12}{section.2.7}
\contentsline {subsection}{\numberline {2.7.1}Algorytm FFT}{18}{subsection.2.7.1}
