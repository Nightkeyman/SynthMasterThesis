...
\begin{figure}[H]
	...
	\label{rys:real_gui}
\end{figure}
Zawiera ono z pola pozwalające na ustanowienie i konfigurację połączenia pomiędzy GUI a DSP:
\begin{itemize}
	\item Rozwijane pole "Port", w którym wybiera się port szeregowy, do którego podłączona jest płyta uruchomieniowa z DSP.
	...
	\item Przycisk "Open", który otwiera połączenie pomiędzy interfejsem użytkownika a DSP. Po pomyślnym nawiązaniu połączenia, tekst tego przycisku zmienia się na "Close". Wówczas przycisk ten służy do zamknięcia połączenia.
\end{itemize} 
