...
%Sprawdzic czy to jest 32KB tylko dla programu czy dla danych jest osobny
...
Odpowiednie zainicjowanie pracy przetwornika cyfrowo analogowego było najbardziej skomplikowanym elementem etapu uruchomienia całego projektu. Polegało ono na ustawieniu:
- ustawienie identyfikatora zdarzeń dMAX, 
- zdefiniowanie przerwania dedykowanego dla DAC, 
- ustawienie rejestrów modułu McASP
- przydzielenia odpowiedniego obszaru pamięci,
- ustawienie parametrów dla przetwornika.
